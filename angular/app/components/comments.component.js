...
var CommentsComponent = (function () {
    ...
    CommentsComponent.prototype.onSubmit = function () {
        ...
        this._commentService.create(token, this.comment).subscribe(function (response) {
            ...
            if (_this.status != "success") {
                ...
                _this.getComments(_this.comment.juguete_id);
            }
        }, function (error) {
    ...
    CommentsComponent.prototype.getComments = function (juguete_id) {
        var _this = this;
        this.loading = 'show';
        this._commentService.getComments(juguete_id).subscribe(function (response) {
